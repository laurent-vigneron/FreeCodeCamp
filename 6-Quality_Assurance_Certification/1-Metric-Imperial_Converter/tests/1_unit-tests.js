...
suite('Unit Tests', function(){
  ...
  suite('Function convertHandler.getNum(input)', function() {
    ...
    test('Fractional Input', function(done) {
      var input = '5/6L';
      assert.equal(convertHandler.getNum(input),0.8333333333333334);
      done();
    });
  ...
  suite('Function convertHandler.getUnit(input)', function() {
    ...
    test('For Each Valid Unit Inputs', function(done) {
      ...
      input.forEach(function(ele) {
        let test = '32'+ele;
        assert.equal(convertHandler.getUnit(test),ele);
      });
      done();
    });
  ...
  suite('Function convertHandler.spellOutUnit(unit)', function() {
    ...
    test('For Each Valid Unit Inputs', function(done) {
      var input = ['gal','l','mi','km','lbs','kg','GAL','L','MI','KM','LBS','KG'];
      var expect = ['gallons','litres','miles','kilometres','pounds','kilograms','gallons','litres','miles','kilometres','pounds','kilograms'];
      input.forEach((ele, i) => {
